...
task :auto_generate_dlls => [:ensure_build_dir] do
  ...
  dll = File.expand_path("solution/AutoGenerated.Message/bin/Debug/net46/AutoGenerated.Message.dll")
  ...
  FileUtils.cp_r(Dir.glob('solution/AutoGenerated.Transfer/bin/Debug/net46/*.dll'), BUILD_DIR)
end
